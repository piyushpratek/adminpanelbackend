...
export const getPieCharts = catchAsyncErrors(async (req, res, next) => {
  let charts;
...
export const getBarCharts = catchAsyncErrors(async (req, res, next) => {
  let charts;
...
export const getLineCharts = catchAsyncErrors(async (req, res, next) => {
  let charts;
